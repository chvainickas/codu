...
6. [Make sure your database is running](#database_url) and setup the tables in the database with Drizzle by running(the exact commands can be seen in the [[package.json]]:
